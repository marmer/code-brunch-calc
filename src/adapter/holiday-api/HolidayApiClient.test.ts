...
describe('HolidayApiClient', () => {
  ...
  it('should test bla something1', async () => {
    // Preparation
    fetchMock.mockIf('https://ipty.de/feiertag/api.php?do=getFeiertage&jahr=2019&loc=BE&outformat=Y-m-d',
      async () => ({
        body: '{ "title": "Fancy Day", "date": "2019-03-04" }',
  ...
  it('should test bla something2', async () => {
    // Preparation
    fetchMock.mockIf('https://ipty.de/feiertag/api.php?do=getFeiertage&jahr=2019&loc=BE&outformat=Y-m-d',
      async () => ({
        body: '[{ "bla": "blub" }]',
  ...
  it('should test bla something3', async () => {
    // Preparation
    fetchMock.mockIf('https://ipty.de/feiertag/api.php?do=getFeiertage&jahr=2019&loc=BE&outformat=Y-m-d',
      async () => ({
        body: '[{ "title": "Fancy Day", "date": 42}]',
        status: 200
      }))
  ...
  it('should test bla something4', async () => {
    // Preparation
    fetchMock.mockIf('https://ipty.de/feiertag/api.php?do=getFeiertage&jahr=2019&loc=BE&outformat=Y-m-d',
      async () => ({
        body: '[{ "title": 42, "date": "2019-03-04" }]',
        status: 200
      }))
